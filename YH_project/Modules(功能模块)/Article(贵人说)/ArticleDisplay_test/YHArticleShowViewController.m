...
@interface YHArticleShowViewController ()<UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, WKNavigationDelegate>
...
@implementation YHArticleShowViewController{
...
- (void)viewDidLoad {
    ...
    NSString *path = @"https://m.toutiao.com/i6573606177983169028/";
