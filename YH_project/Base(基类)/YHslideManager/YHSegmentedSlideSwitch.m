...
@interface YHSegmentedSlideSwitch ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource>{
...
@implementation YHSegmentedSlideSwitch
...
- (void)buildUI {
    ...
    //添加分段选择器
    _segment = [[UISegmentedControl alloc] initWithFrame:CGRectMake(YHScreenWidth/2-60, 10, 120, 30)];
...
- (void)setTitles:(NSArray *)titles {
    ...
    UIFont *slideFont = [UIFont fontWithName:YHFont size:16];
    NSDictionary *attributes = [NSDictionary dictionaryWithObject:slideFont forKey:UITextAttributeFont];
